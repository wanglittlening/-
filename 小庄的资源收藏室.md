...
学习自：https://github.com/LemonIT66/idea_activate
### 方式二：通过设置无效代理激活
测试版本：2024.1.1
...
# 身份验证器（一些软件在进行一些安全操作时，他会给你一个二维码，要你进行认证操作，此时你就需要这个它，比如在开通Google插件开发者时，Github 2FA时会用到）
...
测试工具： [regex101-正则](https://regex101.com/)   [http测试](https://hoppscotch.io/)  [cron表达式](https://tool.p2hp.com/tool-generate-crontab)  

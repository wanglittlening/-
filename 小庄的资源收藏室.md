...
**其它：**
- [WindowTabs](https://github.com/leafOfTree/WindowTabs) (窗口标签化,开源)
...
# 程序员工具箱（包含常见的在线工具）
转换工具：[图片转ICO](https://www.bitbug.net/)   [图片转Base64](https://c.runoob.com/front-end/59/)   [yaml与properties](https://toyaml.com/index.html)   [Base64编码解码](https://base64.us/)

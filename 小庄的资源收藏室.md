...
## 推荐机场：
- [友连机场（24元100G限时，但有手续费，且不限时速度可达1000Mps，速度非常快，节点多70个，可用占比非常高）
](https://c.youlian300.xyz/#/register?code=ckaMnVVh)  [永久地址](有连.com)
- [EFCloud（25元/100G-不限时，节点可用率算比较高的）](https://inv.easyfastcloud.com/#/register?code=RB0pjpWq)
...
## IDEA激活
### 方式一：
IDEA激活码：https://www.cnblogs.com/alex-oos/p/18417197
### 方式二：
...
https://z-library.sk/
--------
最新地址（电报下面有地址）：https://t.me/zlibrary_official
官方飞书：https://x.com/Z_Lib_official
...
# Claude AI（可以使用文件提问, 账号容易被封还不如用chatGPT）
https://claude.ai/
-----
...
扫码下方下载（官方） | [直接网址](http://vp1.kthtea.com.cn/channel/html?page=7SRVYETINU&invited_by=50249085)
![](https://cdn.jsdelivr.net/gh/18476305640/typora@master/images/2023/07/28/1690552920983.png)

去广告版（关注公众号“笔趣阁”回复“天空视频”获取下载链接） | 或[去电报群](https://t.me/PJAPK)搜索
...
[clash-verge](https://github.com/zzzgydi/clash-verge/releases)：  隐藏到后台后，自动关闭UI占用资源，资源占用10M左右，资源占用是最低的代理软件
[clash-nyanpasu](https://github.com/libnyanpasu/clash-nyanpasu)：1.6之前UI和clash-verge很像，整体类似于clash-verge
[clash-verge-rev](https://clash-verge-rev.github.io/index.html): Clash Verge 的延续,界面更美观！资源占用会高一些
...
[karing](https://karing.app/quickstart#%E4%B8%80-%E4%B8%8B%E8%BD%BD): 全平台的，每个平台界面都差不多或说一样，内存占用会比较高100M左右
...
----
Clash For Android 删库，基于此库的[ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid)
...
----
**同类工具hfs:**
- [dufs](https://github.com/sigoden/dufs): 文件夹以zip下载到本地，注意直接启动无参数默认无法下载目录，在要分享的目录下执行命令（需要访问到github文件）:
**仅分享时**：`powershell -Command "& {Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/18476305640/typora/master/images/2024/11/20/dufs.exe' -OutFile 'dufs.exe'; Start-Process -FilePath '.\dufs.exe' -ArgumentList '--allow-archive' -NoNewWindow -Wait}"`
...
- hfs（仅windows）: [官方](https://rejetto.com/hfs), hfs也可以下载文件夹格式是`.tar`, 它的界面如下：
...
```
## 2、安装v2-ui web界面
v2-ui的升级x-ui [github](https://github.com/vaxilu/x-ui)
下面命令是安装[v2-ui](https://github.com/forevergooe/v2-ui)
```bash
cd /root/
...
## 4、转clash订阅
[转换工具1](https://acl4ssr-sub.github.io/)  [转换工具2](https://v2rayse.com/node-convert) [转正工具3（推荐）](https://acl4ssr-sub.github.io/)
...
[搜索适用的脚本](https://sleazyfork.org/zh-CN/scripts/by-site/haijiao.com)

或“[影视坊](https://ysfav.xyz/)”的海角模块中。

**已不推荐：**
- [代替&解析脚本](https://hjfb.org/) [脚本](https://sleazyfork.org/zh-CN/scripts/509766-%E6%B5%B7%E8%A7%92%E7%A4%BE%E5%8C%BA%E5%85%8D%E8%B4%B9%E7%89%88)
...
# [推荐]ToDesk（远程控制软件，除了画质非会员比较低、文件传输比较慢外整体还行）
...
# Greasy Fork（油猴脚本商店）
https://greasyfork.org/zh-CN[[/scripts/by-site/{keyword}]]
----
## 推荐的脚本
- [全网 VIP 视频破解/去广告(流畅解析各平台视频)](https://greasyfork.org/zh-CN/scripts/467776-%E6%87%92%E4%BA%BA%E4%B8%93%E7%94%A8%E7%B3%BB%E5%88%97-%E5%85%A8%E7%BD%91-vip-%E8%A7%86%E9%A2%91%E7%A0%B4%E8%A7%A3%E5%8E%BB%E5%B9%BF%E5%91%8A)
- [iciba划词翻译（应该是最好用的浏览器页页面划词翻译工具了）](https://greasyfork.org/zh-CN/scripts/6303-iciba%E5%88%92%E8%AF%8D%E7%BF%BB%E8%AF%91)
...
# [h'程序员']WSL2 + Docker + 静态IP（在windows上安装ubuntu在Ubuntu上安装docker部署开发环境）
...
# 程序员工具箱（包含常见的在线工具）
转换工具：[图片转ICO](https://www.bitbug.net/)   [图片转Base64](https://c.runoob.com/front-end/59/)   [yaml与properties](https://toyaml.com/index.html)

格式化工具：[JSON格式化工具1-基于svelte-jsoneditor](https://my-search.github.io/svelte-jsoneditor/)   [nginx.conf文件格式化工具](https://18476305640.github.io/nginx-config-format-util/)  

代码对比：[TextCompareDiff](https://my-search.github.io/text-compare-diff)    [diffsuite](https://diffsuite.com/)

测试工具： [regex101-正则](https://regex101.com/)   [http测试](https://tool.p2hp.com/tool-online-http)  [cron表达式](https://tool.p2hp.com/tool-generate-crontab)  

其它：[渐变背景(CSS)](https://webgradients.com/)    [乱码恢复（粘贴乱码数据，得到各种格式的数据）](http://www.mytju.com/classCode/tools/messyCodeRecover.asp)

# TextCompareDiff(在线左右两边简洁的代码对应工具)
...
# Kimi AI(长文本处理，最大处理100M文本，小说随便拿捏，还支持读取url\pdf #chatgpt)
...
----
[Chrome开发者版](https://www.google.com/chrome/dev/)

...
<div id="prompt">
  ...
  <span key="[SD]" class="optional" title="TODO，此项待优化">🗂️基于搜索项（TODO）</span>
...
if(window.MS_SCRIPT_ENV == null || window.MS_SCRIPT_ENV.getSelectedText == null) {
  showMsg("🎨当前脚本无所需API支持，为确保正常使用，请更新脚本到最新版本。<a href='https://update.greasyfork.org/scripts/457020/%E6%88%91%E7%9A%84%E6%90%9C%E7%B4%A2.user.js'>更新</a>");

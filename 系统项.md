...
const keys = [
  "c2stNElJcFRPdDgwTmR0STZHOTEyRGExZkY4N2YzYTRhMGJCYjA2MmVBNDQ3N2NDMjUy",
  "c2stbFJ0Wjl1N3JhNzByMllCOEI4MGU5Y0QwMTgwMDQxQjVBYzQyNzBDMEEzODAxZTAw",
  "c2stYWFVOHZDN0pPd3V6UEVKVWlyRDV1am93Mlp3U01DSHN5Rk9qU21DNWdhMGNIVjU0"
]
...
function chat() {
  ...
  fetch(window.atob("aHR0cHM6Ly9mcmVlLnYzNi5jbS92MS9jaGF0L2NvbXBsZXRpb25z"), requestOptions)
    .then(async response => {
...
function appendToConversationHistory(role, content, messageElementId) {
  ...
  formattedContent = formattedContent.replace(codeBlockRegex, (match, lang, blockContent, inlineContent) => {
    if (blockContent) {
      blockContent = trimNewlines( nextLineMedials(false,blockContent,"\n") )
      return `<pre> 

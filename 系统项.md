...
_describe 使用的公益chatGPT api : https://github.com/popjane/free_chatgpt_api
-- script --
...
function getAnyOne(keys = []) {
  ...
  return window.atob(keys[randomIndex]);
}
...
const providerList = [
  {
    ...
    keys: [
      "sk-4IIpTOt80NdtI6G912Da1fF87f3a4a0bBb062eA4477cC252",
      "sk-lRtZ9u7ra70r2YB8B80e9cD0180041B5Ac4270C0A3801e00",
      "sk-vrr5YeP1ifbJvKuU33C8DdB303B94733A7CdCc14E2DcE8Af"
    ],
    model: ["gpt-4o-mini","gpt-3.5-turbo-0125","gpt-3.5-turbo-1106","selected:gpt-3.5-turbo","gpt-3.5-turbo-16k","net-gpt-3.5-turbo","whisper-1","dall-e-2"]
  },
  {
    baseUrl: ["https://api.chatanywhere.tech/v1","https://api.chatanywhere.org/v1"],
    keys: [
      "sk-4IIpTOt80NdtI6G912Da1fF87f3a4a0bBb062eA4477cC252",
      "sk-3jzcAaPh64eoPCsAdD2b7WDDIVOqm2CaTsGKAWELUZarMIti",
      "sk-Jct9mQRW0Jjw6v8ojIOPoru2IdlGwfUhFapen1Jt1zfTk3yK"
    ],
    model: ["GPT-4","selected:GPT-3.5-TURBO","GPT-4-CA","GPT-3.5-TURBO-CA"]
  }
]
// 选择一个服务提供者信息
let sessionProvider = {
  ...getAnyOne(providerList),
  chooseOut: function() {
    return {
...
sessionProvider.model.forEach(currentModel => {
  ...
  option.selected = trimString(currentModel,"selected:") === sessionProviderSpecific.defaultChooseModel;

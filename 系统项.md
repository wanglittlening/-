...
#chat-control input,
#chat-control button {
  height: 30px; /* Ensure all elements have the same height */
  ...
  line-height: 30px; /* Vertically center the text inside the elements */
}
...
function appendToConversationHistory(role, content, messageElementId) {
  ...
  // 将换行符替换为 <br> 标签
  messageElement.innerHTML = role + " : " + content.replace(/\n/g, "<br>");

...
----
[ChatGPT PC三方客户端下载-github 50k](https://github.com/lencx/ChatGPT)  |  [官方客户端下载](https://openai.com/chatgpt/download/)
...
CPU：[CPU单核性能排行（至少八核 | 游戏）](https://www.topcpu.net/cpu-r/cinebench-r23-single-core)  [CPU多核性能排行（多开）](https://www.topcpu.net/cpu-r/cinebench-r23-multi-core)
...
# 迷雾通（免费版300k/s,可以用来当过渡使用，缺点开机不会自动连接）
https://geph.io/zhs
...
# Kazumi(全平台看番剧|动漫，有内置源可安装其它官方仓库其它源，界面美观。“基于自定义规则的番剧采集APP，支持流媒体在线观看，支持弹幕。”)
https://github.com/Predidit/Kazumi
----
[规则仓库（源）](https://github.com/Predidit/KazumiRules)：仓库已内置，“我的->其它设置-开启**Github镜像**->重启软件->我的->**规则管理**->安装规则”